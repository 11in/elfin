...
"Elf" is "11" in German.
"11ty" is a cheeky way to write something like "eleven-link" or "in the manner of 11," and "-in" can be used in a similar way (i.e. the world "Elfin" does actually mean "elf-like").
